...
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/oscen
...
add wave -noupdate -format Literal -radix hexadecimal /revcfpga_vhd_tst/i1/phonon_shift
...
add wave -noupdate -format Literal /revcfpga_vhd_tst/i1/phrdreq
add wave -noupdate -format Literal /revcfpga_vhd_tst/i1/qrdreq
add wave -noupdate -format Literal -radix hexadecimal /revcfpga_vhd_tst/i1/charge_queue
add wave -noupdate -format Literal -radix hexadecimal /revcfpga_vhd_tst/i1/phonon_queue
...
add wave -noupdate -format Literal /revcfpga_vhd_tst/i1/fbdiv
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/fbfd
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/fbin
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/refin
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/fbclk
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/reffd
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/refclk
add wave -noupdate -format Logic /revcfpga_vhd_tst/i1/dsetuprtn
add wave -noupdate -format Logic /revcfpga_vhd_tst/toscen
add wave -noupdate -format Logic /revcfpga_vhd_tst/clk50
add wave -noupdate -format Literal /revcfpga_vhd_tst/retdiv
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1612500 ps} 0} {{Cursor 2} {1712500 ps} 0}
...
update
WaveRestoreZoom {1062570 ps} {2375070 ps}
